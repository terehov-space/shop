<template>
    <v-col
        class="d-flex justify-start align-stretch flex-wrap no--gutters bottom-margin ma-0 pa-0"
        cols="12"
        md="12"
    >
        <v-col
...
.catalog_link {
    ...
    &:hover {
        box-shadow: 0px 3px 0 0 rgb(0 0 0 / 20%), 0 2px 2px 0 rgb(0 0 0 / 14%), 0 1px 5px 0 rgb(0 0 0 / 12%);
        border-color: #000000;
    }
}
